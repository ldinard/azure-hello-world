...
const companyFields: FieldDef[] = [
  ...
  { objectName: 'Company', objectId: 65535, objectType: 'Entity', fieldName: 'Address', fieldId: 10002, apiName: 'Address', fieldType: 'Text', formatType: 'Text', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  ...
  { objectName: 'Company', objectId: 65535, objectType: 'Entity', fieldName: 'Phone', fieldId: 10007, apiName: 'Phone', fieldType: 'Text', formatType: 'Text', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
...
const contactFields: FieldDef[] = [
  ...
  { objectName: 'Contact', objectId: 65537, objectType: 'Person', fieldName: 'Phone', fieldId: 10106, apiName: 'Phone', fieldType: 'Text', formatType: 'Text', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  ...
  { objectName: 'Contact', objectId: 65537, objectType: 'Person', fieldName: 'Address', fieldId: 10108, apiName: 'Address', fieldType: 'Text', formatType: 'Text', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
...
const opportunityFields: FieldDef[] = [
  ...
  { objectName: 'Opportunity', objectId: 65565, objectType: 'Entity', fieldName: 'Open Date', fieldId: 10204, apiName: 'OpenDate', fieldType: 'Date', formatType: 'Date', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  { objectName: 'Opportunity', objectId: 65565, objectType: 'Entity', fieldName: 'Close Date', fieldId: 10205, apiName: 'CloseDate', fieldType: 'Date', formatType: 'Date', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
];
...
const clientFields: FieldDef[] = [
  ...
  { objectName: 'Client', objectId: 84596, objectType: 'Entity', fieldName: 'Open Date', fieldId: 10303, apiName: 'OpenDate', fieldType: 'Date', formatType: 'Date', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  { objectName: 'Client', objectId: 84596, objectType: 'Entity', fieldName: 'Close Date', fieldId: 10304, apiName: 'CloseDate', fieldType: 'Date', formatType: 'Date', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  { objectName: 'Client', objectId: 84596, objectType: 'Entity', fieldName: 'Total WIP', fieldId: 10305, apiName: 'TotalWIP', fieldType: 'Number', formatType: 'Currency', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  { objectName: 'Client', objectId: 84596, objectType: 'Entity', fieldName: 'Total AR', fieldId: 10306, apiName: 'TotalAR', fieldType: 'Number', formatType: 'Currency', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
  { objectName: 'Client', objectId: 84596, objectType: 'Entity', fieldName: 'Last WIP', fieldId: 10307, apiName: 'LastWIP', fieldType: 'Number', formatType: 'Currency', systemFieldType: '', required: false, multiSelect: false, choiceValues: [], referencedObjects: [], isCalculated: false, isSystemField: false },
];
